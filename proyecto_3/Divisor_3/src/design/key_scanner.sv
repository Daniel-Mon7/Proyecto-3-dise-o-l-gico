module key_scanner #(
    ...
    // Contador de filas: Avanza a la siguiente fila solo si hay unn tick y permiso
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin
            scanned_row <= 2'd0;
    ...
    // Decodificador de 2 a 4 bits para la salida física de filas (Lógica del One-Hot)
    always_comb begin
        case (scanned_row)
