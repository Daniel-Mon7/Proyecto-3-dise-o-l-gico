module anode_control (
    ...
    always_ff @(posedge clk or posedge rst) begin
        ...
        if (rst) begin
            ...
            case (sel) // Solucion problema que no se mostraban bien los numeros de 2 digitos
                2'd0: anode <= 4'b1000; // D4 físico
                2'd1: anode <= 4'b0001; // D3 físico
                2'd2: anode <= 4'b0010; // D2 físico
                2'd3: anode <= 4'b0100; // D1 físico
            endcase
        end
